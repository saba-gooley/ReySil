...
export default async function ChoferLayout({
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      {/* WhatsApp FAB */}
      <a
        href={`https://wa.me/${process.env.NEXT_PUBLIC_REYSIL_WSP_NUMBER || "5491100000000"}`}
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-20 right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg hover:bg-green-600 active:bg-green-700"
        aria-label="WhatsApp"
      >
