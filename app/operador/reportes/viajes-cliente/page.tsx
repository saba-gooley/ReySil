...
import { ReporteViajesClienteView } from "@/components/operador/reporte-viajes-cliente-view";
import { todayAR } from "@/lib/utils/date";

export const dynamic = "force-dynamic";

export default async function ViajesClientePage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-4">
      ...
      <ReporteViajesClienteView rows={report.byClient} total={report.total} from={from} to={to} />
    </div>
  );
}
